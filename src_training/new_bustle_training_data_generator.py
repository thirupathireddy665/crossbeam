...
def generate_training_data(program_synthesizer, gen_training_data_set, random_inputs,
    ...
    for program in random_programs:
        ...
        string_return_type_programs = list(
            filter(lambda child_program: child_program.getReturnType() == STR_TYPES['type'] and child_program.size < 4,
                   child_programs_set))
...
if __name__ == "__main__":
    ...
    log_filename = logs_directory + "new_bustle_training.log"
    os.makedirs(os.path.dirname(log_filename), exist_ok=True)

    training_data_filename = data_directory + "new_bustle_training_data.csv"
