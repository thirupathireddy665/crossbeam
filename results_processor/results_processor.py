...
if __name__ == "__main__":
    ...
    logs = ["bustle_bruteforce_output.log", "encoded_bustle_output.log",
            "encoded_bustle_output_100.log",
            "encoded_ranked_top_bustle_output.log", "encoded_ranked_bottom_bustle_output.log"]
    logkeys = ["Brute-force", "Bustle", "Bustle_100", "Ranked30", "Bottom30"]
