...
class StrLiteral(Str):
    ...
    def get_argument_programs(self):
        return None
...
class StrReplace(Str):
    ...
    def get_argument_programs(self):
        arguments = [self.str, self.old, self.new]
        return arguments
...
class StrSubstr(Str):
    ...
    def get_argument_programs(self):
        arguments = [self.str, self.start, self.end]
        return arguments
...
class StrIte(Str):
    ...
    def get_argument_programs(self):
        arguments = [self.condition, self.true_case, self.false_case]
        return arguments
...
class StrReplaceAdd(Str):
    ...
    def get_argument_programs(self):
        arguments = [self.str, self.start, self.end, self.add_str]
        return arguments
...
class StrReplaceMulti(Str):
    ...
    def get_argument_programs(self):
        arguments = [self.str, self.old, self.new, self.count]
        return arguments
                ...
                for prog2 in layer2_prog:
                    ...
                    for prog3 in layer3_prog:
                        if prog3.toString() == p2_str:
                            continue
                        for prog4 in layer4_prog:
                            yield StrReplaceMulti(prog1, prog2, prog3, prog4)
...
class IntPlus(Int):
    ...
    def get_argument_programs(self):
        arguments = [self.left, self.right]
        return arguments
...
class IntIndexOf(Int):
    ...
    def get_argument_programs(self):
        arguments = [self.input_str, self.substr, self.start]
        return arguments
...
class IntFirstIndexOf(Int):
    ...
    def get_argument_programs(self):
        arguments = [self.input_str, self.substr]
        return arguments
...
class BoolContain(Bool):
    ...
    def get_argument_programs(self):
        arguments = [self.str, self.substr]
        return arguments
...
class BoolSuffixof(Bool):
    ...
    def get_argument_programs(self):
        arguments = [self.str, self.suffix]
        return arguments
...
class BoolPrefixof(Bool):
    ...
    def get_argument_programs(self):
        arguments = [self.str, self.prefix]
        return arguments
...
class BoolGreaterThan(Bool):
    ...
    def get_argument_programs(self):
        arguments = [self.first_int, self.second_int]
        return arguments
